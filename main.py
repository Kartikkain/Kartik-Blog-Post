...
class BlogPost(db.Model):
    ...
    b_comments = relationship("Comments", back_populates="blog_comments")
...
class Comments(db.Model):
    ...
    blog_comments = relationship("BlogPost", back_populates="b_comments")
...
gravatar = Gravatar(app, size=100, rating='g', default='identicon', force_default=False, force_lower=False, use_ssl=False,
                    base_url=None)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and check_password_hash(user.password, password):
            ...
            flash(message="Invalid Password and Email")
            return redirect(url_for("login"))
